<template>
    <div id="supplierUser" class="supplierUserPage">
        <div class="search-list clearfix">
            ...
            <div class="search-btn clearfix">
                <div class="btn">
                    <el-button type="primary" @click="doQuerySupplierUser()" plain size="mini" icon="el-icon-search">搜索</el-button>
                </div>
                <div class="btn">
        ...
        <div class="table-content">
            <div class="table-title">
                ...
                <div class="table-title-btn">
                    <el-button type="primary" v-entity="144" @click="addSupplierUser()" plain size="mini">新增员工</el-button>
                    <el-button type="primary" v-entity="145" @click="updateSupplierUser()" plain size="mini">修改员工</el-button>
                    <el-button type="primary" v-entity="146" @click="deleteSysUser()" plain size="mini">删除员工</el-button>
                    <el-button type="primary" v-entity="147" @click="downloadExcelFile()" plain size="mini">导出</el-button>
                </div>
            </div>
            <tableCommon tableName="supplierUserTable" ref="table" :head="head" :showNum="true"></tableCommon>
        </div>
        <el-dialog
                title="员工区域授权"

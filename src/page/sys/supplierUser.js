...
export default {
    ...
    methods: {
        ...
        addSupplierUser:function () {
            let that = this;
            let item = {
                urlName: "新增员工",
                urlId: "10" + new Date().getTime(),
                urlPath: "/sys/addSupplierUser.vue",
                urlPathName: "/addSupplierUser",
                query: {}
            }
            that.$emit('openTab', item);
        },
        updateSupplierUser:function () {
            let that = this;
            ...
            let item = {
                urlName: "修改员工",
                urlId: "10" + new Date().getTime(),
                urlPath: "/sys/updateSupplierUser.vue",
                urlPathName: "/updateSupplierUser",

...
export default {
    ...
    methods: {
        ...
        doQuerySysStaticData:function () {
            ...
            that.common.postUrl("api/sysTenantDefBO.ajax?cmd=getSysCarrierInfo", {"id":that.id},function(data){
                that.obj = data;
                that.obj.carrierId = data.carrierId + "";
                that.obj.clientTenantId = data.clientTenantId;
                that.obj.tenantFullName = data.clientTenantId;
                that.obj.supplierFullName = data.supplierTenantId;
                that.obj.supplierTenantId = data.supplierTenantId;
                that.obj.storeId = data.storeId;
                that.obj.storeName = data.storeId;
                that.obj.receiveStoreId = data.receiveStoreId;
                that.obj.storeFullName = data.receiveStoreId;

<template>
    <div id="sysUser" class="sysUserPage">
        <div class="search-list clearfix">
            <div class="search-form clearfix">
                ...
                <div class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.oragnizeId" placeholder="请选择">
            ...
            <div class="search-btn clearfix">
                <div class="btn">
                    <el-button type="primary" @click="doQuerySysUser()" plain size="mini" icon="el-icon-search">搜索</el-button>
                </div>
                <div class="btn">
        ...
        <div class="table-content">
            <div class="table-title">
                ...
                <div class="table-title-btn">
                    <el-button type="primary" v-entity="75" @click="addSysUser()" plain size="mini">新增员工</el-button>
                    <el-button type="primary" v-entity="76" @click="updateSysUser()" plain size="mini">修改员工</el-button>
                    <el-button type="primary" v-entity="77" @click="authorization()" plain size="mini">区域授权</el-button>
                    <el-button type="primary" v-entity="78" @click="deleteSysUser()" plain size="mini">删除员工</el-button>
                    <el-button type="primary" v-entity="79" @click="downloadExcelFile()" plain size="mini">导出</el-button>
                </div>
            </div>
            <tableCommon tableName="sysUserTable" ref="table" :head="head" :showNum="true"></tableCommon>
        </div>
        <el-dialog
        title="员工区域授权"
...
<script>
    import sysUser from './sysUser.js'

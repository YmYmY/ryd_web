        ...
        <div class="common-info">
            ...
            <ul class="content clearfix" v-show="obj.carrierId==4 || obj.carrierId == 5">
                <li class="item" >
                    ...
                    <div class="input-text">
                        <el-select  v-model="obj.storeFullName" filterable   @change="selectStore" placeholder="请选择门仓名称">
...
<script>
    import addSysCarrierInfo from './addSysCarrierInfo.js'
    export default addSysCarrierInfo
</script>
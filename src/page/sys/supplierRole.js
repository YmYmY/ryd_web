...
export default {
    ...
    methods: {
        ...
        //查询角色列表
        doQuerySupplierRole:function () {
            let that = this;
            let url = "api/sysRoleBO.ajax?cmd=doQuerySupplierRole";
        ...
        addSupplierRole:function () {
            ...
            let item = {
                ...
                urlPath: "/sys/addSupplierRole.vue",
                urlPathName: "/addSupplierRole",
                query: {}
            }
            that.$emit('openTab', item);
        },
        //修改角色
        updateSupplierRole:function () {
            let that = this;
            ...
            let item = {
                urlName: "修改角色",
                urlId: "11" + new Date().getTime(),
                urlPath: "/sys/updateSupplierRole.vue",
                urlPathName: "/updateSupplierRole",

import {
  ...
  export default {
    ...
    methods: {
      ...
      //查询角色列表
      doQuerySysRole:function () {
        let that = this;
        let url = "api/sysRoleBO.ajax?cmd=doQuerySysRole";
      ...
      addSysRole:function () {
        ...
        let item = {
          ...
          urlPath: "/sys/addSysRole.vue",
          urlPathName: "/addSysRole",
          query: {}
        }
      ...
      updateSysRole:function () {
        ...
        let item = {
          urlName: "修改角色",
          urlId: "11" + new Date().getTime(),
          urlPath: "/sys/updateSysRole.vue",
          urlPathName: "/updateSysRole",

...
export default {
    ...
    data() {
        return {
            ...
            head :[
                ...
                {"name":"部门","code":"oragnizeName","width":"100","type" : "text"},
                {"name":"区域权限","code":"regionName","width":"100","type" : "text"},
    ...
    methods: {
        ...
        //查询角色列表
        doQuerySysUser:function () {
            let that = this;
            let url = "api/sysUserBO.ajax?cmd=doQuerySysUser";
        ...
        doQuerySysStaticData:function () {
            ...
            that.common.postUrl("api/sysStaticDataBO.ajax?cmd=selectSysOragnize",{"hasAll":true},function (data) {
        ...
        addSysUser:function () {
            ...
            let item = {
                ...
                urlPath: "/sys/addSysUser.vue",
                urlPathName: "/addSysUser",
                query: {}
            }
        ...
        updateSysUser:function () {
            ...
            let item = {
                urlName: "修改员工",
                urlId: "10" + new Date().getTime(),
                urlPath: "/sys/updateSysUser.vue",
                urlPathName: "/updateSysUser",

        ...
        <div class="table-content">
            <div class="table-title">
                ...
                <div class="table-title-btn">
                    <el-button type="primary" v-entity="361" @click="showMakeUp()" plain size="mini">信息补录</el-button>
                    <el-button type="primary" v-entity="362" @click="pushFee()" plain size="mini">推送费用</el-button>
                    <el-button type="primary" v-entity="362" @click="cancelOrder()" plain size="mini">取消运单</el-button>
                    <el-button type="primary" v-entity="363" @click="showRefund()" plain size="mini">退款</el-button>
                    <el-button type="primary" v-entity="364" @click="downloadExcelFile()" plain size="mini">导出</el-button>
                </div>
            </div>
            <tableCommon tableName="fcIncomeExpensesTable" @dblclickItem="dblclickItem" ref="table" :head="head" :showNum="true" :doSum="true"></tableCommon>
        </div>
...
<script>
    import fcIncomeExpenses from './fcIncomeExpenses.js'
    export default fcIncomeExpenses
</script>
<style scoped>

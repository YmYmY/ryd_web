<template>
  <div id="transferAddDetail" class="transferAddDetailPage">
    ...
    <div class="common-info">
      ...
      <ul class="content clearfix" v-show="currentTab.selectType == 1">
        ...
        <li class="item">
          ...
          <div class="input-text">
            <el-input v-model="order.packageNumber" maxlength="5" v-mynumval></el-input>
          </div>
        </li>
        <li class="item">
        ...
        <li class="item">
          ...
          <div class="input-text">
            <el-input v-model="order.packageVolume" maxlength="8" v-mydoubleval></el-input>
        ...
        <li class="item">
          <label class="label-term">接货网点</label>
           <div class="input-text">
              <el-select v-model="order.sourceOrgId"  placeholder="请选择" @click.native="queryOrg()">
        ...
        <li class="item">
          ...
          <div class="input-text">
            <el-select v-model="order.destOrgId"  placeholder="请选择"   @click.native="queryOrg()">
              <el-option v-for="item in orgList" :key="item.orgId" :label="item.orgFullName" :value="item.orgId"></el-option>
            </el-select>
          </div>
        </li>
       ...
       <ul class="content clearfix" v-show="currentTab.selectType == 2">
        <li class="item">
          <label class="label-term"><em>*</em>供应商</label>
          <div class="input-text">
            <el-select v-model="order.supplierTenantName" @change="selectSupplierTenant" filterable placeholder="请选择">
        ...
        <!-- <li class="item" v-show="order.combinedSts == 1">
          <label class="label-term">运费分摊</label>
          <div class="input-text">
             <el-select v-model="order.fee.divideType" placeholder="请选择" @change="selectTotalFee()">
      ...
      <h3 v-show="currentTab.selectType == 1 || order.combinedSts == 2" class="common-title mb_20"><span class="title-name">中转费用</span></h3>
      ...
      <ul class="content clearfix" v-show="order.combinedSts ==2 && currentTab.selectType==2"> 
        <li class="item">
          <label class="label-term">中转成本合计</label>
          <div class="input-text">
            <el-input v-model="order.fee.totalFeeDouble" @blur="selectTotalFeeDouble()"></el-input>
          </div>
        </li>
        <li class="item">
          <label class="label-term">中转单号</label>
          ...
          <tbody>
              <tr v-for="(data,index) in tableData" :key="index">
                  ...
                  <td :width="hd.width == undefined ? 60 : hd.width" v-for="hd in head" :key="hd.code">
                    ...
                    <el-input v-if="hd.isEdit" v-model="data[hd.code]" @input="forceUpdate()"></el-input>
                  </td>
              </tr>
          </tbody>
      </table>
    ...
    <div class="page-bot-btn">
        <el-button type="info" @click="goback" v-show="!outView" >上一步</el-button>
        <el-button type="primary" @click="saveOrUpdate(1)" v-show="!outView">保存</el-button>

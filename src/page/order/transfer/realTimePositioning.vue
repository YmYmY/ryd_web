<template>
    <div id="realTimePositioning" class="realTimePositioningPage">
...
<script>
    import realTimePositioning from './realTimePositioning.js'
    export default realTimePositioning
</script>
<style lang="scss">
.realTimePositioningPage{
    .bm-view{
        height: 600px;
        width: 100%;
    }

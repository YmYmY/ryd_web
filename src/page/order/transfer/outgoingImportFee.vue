  ...
  <div id="listImport">
    <div class="search-list clearfix">
      ...
      <div class="item have-label item2row">
          <label class="label">            
            <el-select v-model="query.queryImportTransitFeeTimeType" @change="forceUpdate()">
               <el-option v-for="item in selectTransitOrderFeeTimeList" :key="item.codeValue" :label="item.codeName" :value="item.codeValue"></el-option>
            </el-select>
          </label>
          <div class="input-text">
            <dataPicker :model="query.queryFeeTimes" @callback="data=>{query.queryFeeTimes=data}"></dataPicker>
          </div>
        </div>
        <div class="item have-label item2row">
          <label class="label">            
       ...
       <div class="item">
         ...
         <div class="item" >
          <label class="label">导入人</label>
          <div class="input-text">
             <el-input v-model="query.importFeeOpName"  placeholder="导入人" type="text"></el-input>
          </div>
        </div>
      </div>
    ...
    <div class="table-content">
      <div class="table-title">
        ...
        <div class="table-title-btn">
          <el-button type="primary" plain size="mini" @click="importTransitOrderFee()" v-entity="576">成本导入</el-button>
          <el-button type="primary" plain size="mini" @click="exportOrders()" v-entity="578">导出</el-button>
...
<script>
import outgoingImportFee from './outgoingImportFee.js'
export default outgoingImportFee
</script>
<style scoped>

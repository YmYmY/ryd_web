<template>
    <div id="updateSendVehicle">
        ...
        <!-- <el-dialog title="新增手工账" :visible.sync="mapShow" width="1000px">
            <baidu-map class="bm-view"  :center="mapObj.center" :zoom="map.zoom"></baidu-map>
        </el-dialog> -->
    </div>
</template>
<script>
    import updateSendVehicle from './updateSendVehicle.js'
    export default updateSendVehicle
</script>
<style lang="scss">
    #updateSendVehicle{
        .el-dialog{

  ...
  <div id="listImport">
    <div class="search-list clearfix">
      ...
      <div class="item">
        ...
        <div class="item">
          ...
          <div class="input-text">
            <el-select v-model="query.paymentType" placeholder="请选择">
    ...
    <div class="table-content">
      <div class="table-title">
        <h3>
          <span>订单列表</span>
          <el-tooltip effect="light" content="系统对接单，双击查看详情" placement="right">
            <img class="tip" src="@/static/image/$tenantId$/tip.png" alt="">
          </el-tooltip>
        </h3>
        <div class="table-title-btn">
          <el-button type="primary" plain size="mini" @click="addOrder()"  v-entity="271"  >运单录入</el-button>
          <el-button type="primary" plain size="mini" @click="importOrder()" v-entity="272" >导入</el-button>
          <!-- <el-button type="primary" plain size="mini" @click="cancelOrder()">取消运单</el-button> -->
          <el-button type="primary" plain size="mini" @click="exportOrders()" v-entity="273" >导出</el-button>
        </div>
      </div>
...
<script>
import ordersImport from './ordersImport.js'

...
import addLabourAccount from "@/page/demo/addLabourAccount/addLabourAccount.vue"
...
export default {
  ...
  methods: {
    ...
    showAddLabourAccount(){
      this.addLabourAccountShow = true;
    },
    closeCallback(data){
      this.addLabourAccountShow = false;
      console.log(data);
    },
    inputtest(){
      setTimeout(() => {        

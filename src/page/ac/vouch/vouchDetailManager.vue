<template>
  <div id="vouchDetailManager" class="financeTallyPage">
    ...
    <div class="table-content">
      <div class="table-title">
        ...
        <div class="table-title-btn" v-if="!revokeFlag" >
          <el-button type="primary" plain size="mini" @click="exportOrders()" v-entity="350" >导出</el-button>
        </div>
          <div class="table-title-btn" v-if="revokeFlag">
...
<script>
import vouchDetailManager from './vouchDetailManager.js'
export default vouchDetailManager
</script>
<style lang="scss">
  .financeTallyPage{
    .calcSurplus{

<template>
    <div id="addCmAbnormal" class="infoPage addCmAbnormalPage">
            ...
            <ul class="content clearfix">
                <li class="item" >
                    ...
                    <div class="input-text">
                        <el-input v-model="trackingNum" v-bind:disabled=true  maxlength="30"></el-input>
                    </div>
                </li>
                <li class="item" >
        ...
        <!-- 查找订单 -->
        <cmOrders class="cmOrders" ref="cmOrders" :dialogTableShow="dialogTableShow" @sureCallback="sureCallback"></cmOrders>
    </div>
</template>
<script>
    import addCmAbnormal from './addCmAbnormal.js'
    export default addCmAbnormal
</script>
<style lang="scss">
.addCmAbnormalPage{
    .cmOrders{

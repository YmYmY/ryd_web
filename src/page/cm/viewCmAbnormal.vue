<template>
    <div id="dealCmAbnormal" class="infoPage">
        <div class="common-info">
            ...
            <ul class="content clearfix">
                ...
                <li class="item" >
                    ...
                    <div class="input-text">
                        <el-button type="primary" v-bind:disabled=true @click="showDialog()">查找订单</el-button>
                    </div>
                </li>
            </ul>
            ...
            <ul class="content clearfix">
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-checkbox v-model="clientType" v-bind:disabled=true><em>注:勾选后客户端可同步看到异常信息</em></el-checkbox>
                    </div>
                </li>
            </ul>
            <ul class="content clearfix">
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.responId" placeholder="请选择" @change="selectType" v-bind:disabled=true>
                ...
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.abnormalType" placeholder="请选择" v-bind:disabled=true>
                ...
                <li class="item" >
                    ...
                    <div class="input-text">
                        <el-input v-model="obj.abnormalNum" v-bind:disabled=true maxlength="30"></el-input>
                    </div>
                </li>
                <li class="item" >
                    <label class="label-term">异常金额</label>
                    <div class="input-text">
                        <el-input v-model="obj.registerFee" v-bind:disabled=true maxlength="10" v-mydoubleval></el-input>
                    </div>
                </li>
            </ul>
            <ul class="content clearfix">
                <li class="item w_auto">
                    ...
                    <div class="input-text">
                        <el-input maxlength="200" type="textarea" v-bind:disabled=true :autosize="{ minRows: 3, maxRows: 4}" placeholder="请输入内容" v-model="obj.abnormalNote"></el-input>
                    </div>
                </li>
            </ul>
            ...
            <ul class="content clearfix">
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.dealType" placeholder="请选择" v-bind:disabled=true>
            ...
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">平台相关</label>
                    <el-checkbox v-model="platformType" v-bind:disabled=true @change="clickType"></el-checkbox>
                </li>
                <li class="item">
                    <label class="label-term"><em>*</em>理赔对象</label>
                    <div class="input-text">
                        <el-select v-model="obj.claimId" placeholder="请选择" @change="selectTypePlatform" v-bind:disabled=true>
                ...
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.feeType" placeholder="请选择" v-bind:disabled=true>
                ...
                <li class="item" >
                    ...
                    <div class="input-text">
                        <el-input v-model="obj.dealFee" maxlength="10" v-bind:disabled=true v-mydoubleval></el-input>
                    </div>
                </li>
            </ul>
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">客户相关</label>
                    <el-checkbox v-model="clientOneType" v-bind:disabled=true @change="clickType"></el-checkbox>
                </li>
                <li class="item">
                    <label class="label-term"><em>*</em>理赔对象</label>
                    <div class="input-text">
                        <el-select v-model="obj.clientClaimId" placeholder="请选择" @change="selectTypeClient" v-bind:disabled=true>
                ...
                <li class="item">
                    <label class="label-term"><em>*</em>费用类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.clientFeeType" placeholder="请选择" v-bind:disabled=true>
                ...
                <li class="item" >
                    <label class="label-term"><em>*</em>处理金额</label>
                    <div class="input-text">
                        <el-input v-model="obj.clientDealFee" maxlength="10" v-bind:disabled=true v-mydoubleval></el-input>
                    </div>
                </li>
            </ul>
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">供应商相关</label>
                    <el-checkbox v-model="supplierType" v-bind:disabled=true @change="clickType"></el-checkbox>
                </li>
                <li class="item">
                    <label class="label-term"><em>*</em>理赔对象</label>
                    <div class="input-text">
                        <el-select v-model="obj.supplierClaimId" placeholder="请选择" @change="selectTypeSupplier" v-bind:disabled=true>
                ...
                <li class="item">
                    <label class="label-term"><em>*</em>费用类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.supplierFeeType" placeholder="请选择" v-bind:disabled=true>
                ...
                <li class="item" >
                    <label class="label-term"><em>*</em>处理金额</label>
                    <div class="input-text">
                        <el-input v-model="obj.supplierDealFee" maxlength="10" v-bind:disabled=true v-mydoubleval></el-input>
                    </div>
                </li>
            </ul>
            <ul class="content clearfix">
                <li class="item w_auto">
                    ...
                    <div class="input-text">
                        <el-input maxlength="200" type="textarea" v-bind:disabled=true :autosize="{ minRows: 3, maxRows: 4}" placeholder="请输入内容" v-model="obj.dealNote"></el-input>
                    </div>
                </li>
            </ul>
            ...
            <ul class="content clearfix">
                <li class="item w_auto">
                    ...
                    <div class="input-text">
                        <el-input maxlength="200" type="textarea"  v-bind:disabled=true :autosize="{ minRows: 3, maxRows: 4}" placeholder="此内容仅平台可见" v-model="obj.remarks"></el-input>
                    </div>
                </li>
            </ul>
            <div class="bot-btn">
...
<script>
    import viewCmAbnormal from './viewCmAbnormal.js'
    export default viewCmAbnormal
</script>
<template>
    <div id="updateCmDealer" class="infoPage">
        <div class="common-info">
            ...
            <ul class="content clearfix" v-show="collectionType">
                ...
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-input type="password" @input="forceUpdate" v-bind:disabled="showPassword" v-model="obj.userPassword" autoComplete="new-password"  maxlength="20"></el-input>
...
<script>
    import updateCmDealer from './updateCmDealer.js'
    export default updateCmDealer
</script>
<template>
  <div id="homeSupplier" class="homePage">
    <div class="main">
      <div class="header clearfix" ref="header">
        ...
        <div class="fr">
          <!-- <img src="@/static/image/$tenantId$/print.png" class="print fl" alt="">
          <img src="@/static/image/$tenantId$/msg.png" class="msg fl" alt="">
          <img src="@/static/image/$tenantId$/help.png" class="help fl" alt="">
          <img src="@/static/image/$tenantId$/skin.png" class="skin fl" alt=""> -->
          <div class="user fl">
          ...
          <div class="menu">
            <div class="menuList">
              ...
              <div class="menu-one" @click="openTab(tab1)" v-for="tab1 in tabsCache" :key="tab1.urlId" @mouseenter="showChild(tab1)" @mouseleave="hideChild(tab1)">
                ...
                <!-- 二层 -->
                <div class="menu-item menu-two" v-for="tab2 in tab1.children" :key="tab2.urlId" v-show="tab1.isOpen">
...
<script>
  import homeSupplier from "./homeSupplier.js"

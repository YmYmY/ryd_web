<template>
    <div id="addSysProductDelivery" class="addSysProductDeliveryPage">
        <div class="common-info">
            <ul class="content clearfix">
                ...
                <li class="item">
                    <label class="label-term">取件时效</label>
                    <div class="input-text">
                        <el-input v-model="obj.agingNum"    maxlength="10" v-mynumval ></el-input>
                    </div>
                </li>
                <li class="item">
                ...
                <li class="item">
                    <label class="label-term">生效时间</label>
                    <div class="input-text">
        ...
        <ladderTable ref="ladderTable" :head="head"   @areaCallback="areaCallback"></ladderTable>
...
<script>
    import addSysProductDelivery from './addSysProductDelivery.js'
    export default addSysProductDelivery
</script>
<style lang="scss">
.addSysProductDeliveryPage{

        ...
        <div class="common-info">
            ...
            <ul class="content clearfix">
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.orderTypeOne" placeholder="请选择" v-bind:disabled="true" @change="forceUpdate">
                ...
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.customerIdOne" placeholder="请选择" @change="forceUpdate">
                ...
                <li class="item">
                    ...
                    <div class="input-text">
                        <el-select v-model="obj.operationIdOne" placeholder="请选择" @change="forceUpdate">
            ...
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">订单类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.orderTypeTwo" placeholder="请选择" v-bind:disabled="true" @change="forceUpdate">
                            <el-option v-for="item in orderTypeList" :key="item.codeValue" :label="item.codeName" :value="item.codeValue"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">客户部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.customerIdTwo" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in customerList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">运营部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.operationIdTwo" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in operationList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
            ...
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">订单类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.orderTypeThree" placeholder="请选择" v-bind:disabled="true" @change="forceUpdate">
                            <el-option v-for="item in orderTypeList" :key="item.codeValue" :label="item.codeName" :value="item.codeValue"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">客户部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.customerIdThree" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in customerList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">运营部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.operationIdThree" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in operationList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
            ...
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">订单类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.orderTypeFour" placeholder="请选择" v-bind:disabled="true" @change="forceUpdate">
                            <el-option v-for="item in orderTypeList" :key="item.codeValue" :label="item.codeName" :value="item.codeValue"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">客户部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.customerIdFour" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in customerList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">运营部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.operationIdFour" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in operationList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
            ...
            <ul class="content clearfix">
                <li class="item">
                    <label class="label-term">订单类型</label>
                    <div class="input-text">
                        <el-select v-model="obj.orderTypeFives" placeholder="请选择" v-bind:disabled="true" @change="forceUpdate">
                            <el-option v-for="item in orderTypeList" :key="item.codeValue" :label="item.codeName" :value="item.codeValue"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">客户部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.customerIdFives" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in customerList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li class="item">
                    <label class="label-term">运营部门</label>
                    <div class="input-text">
                        <el-select v-model="obj.operationIdFives" placeholder="请选择" @change="forceUpdate">
                            <el-option v-for="item in operationList" :key="item.oragnizeId" :label="item.oragnizeName" :value="item.oragnizeId"></el-option>
                        </el-select>
                    </div>
                </li>

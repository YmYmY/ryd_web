<template>
    <div id="supplierFreightSetting" class="supplierFreightSettingPage">
        <div class="common-info">
            ...
            <div class="tip">注：1.总运费折扣指的是按每个自然月对账时，对该供应商发送运费总额达到一定金额时做出的运费折扣优惠
...
<script>
    import supplierFreightSetting from './supplierFreightSetting.js'
    export default supplierFreightSetting
</script>
<style lang="scss">
    .supplierFreightSettingPage{
        .tenantPrice{
            &>div{
